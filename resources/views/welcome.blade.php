    ...
    <div class="site-width ph3 center">
        ...
        <div class="center mt3 brdr1--top bcg05">
            <p class="mt2 ft3 tar tcg30">
                created by <a href="https://jakebennett.net" class="tc2">Jake Bennett</a>
            </p>
        </div>
    </div>
